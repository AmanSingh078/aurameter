  ...
  return (
    <>
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen text-white overflow-hidden py-10 px-4">
        ...
        {/* Badge */}
        <div 
          className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-xs font-medium mb-8 backdrop-blur-sm"
          style={{
        ...
        >
          Measure Your Aura.<br />Grow Your Energy.
        </h1>
